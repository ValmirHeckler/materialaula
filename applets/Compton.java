...
class InputPanel extends Panel implements ActionListener {
	...
	add(new Label("Energia Cinética do Fóton (keV)"));
	add(textEnergy); 
	add(new Label("Ângulo dispersão Fóton (deg)"));
	add(textTheta); 
...
class InfoPanel extends Canvas {
	...
	g.setFont(Compton.font3);
	g.drawString("Elétron", 170, 12);
	
	g.setFont(Compton.font2);
	g.drawString("Energia Cinética = " + 
